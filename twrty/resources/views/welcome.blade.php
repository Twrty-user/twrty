@include('layouts.header')
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12 offset-md-1">
          <div class="detail-box">
            <h2><b>
            From essential services to <br> earning opportunities. We're <br>an all-in-one platform.
            </b></h2>
          </div>
        </div>
        <!-- <div class="col-md-6">
  ...
  <section class="about_section">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12 offset-md-1">
          <div class="slider_form btm_input">
           <button type="button" class="btn btn-primary btn-spacing">Consumer</button>
            <button type="button" class="btn btn-primary btn-spacing">Driver</button>
            <button type="button" class="btn btn-primary btn-spacing">Merchant</button>
          </div>
        </div>
      </div>
    </div>
